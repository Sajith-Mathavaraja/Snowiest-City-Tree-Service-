    ...
    <section className="py-24 relative overflow-hidden">
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-gray-300 max-w-2xl mx-auto">See the difference our professional tree care makes.</p>
        </div>
          ...
          {projects.map((proj, idx) => (
            <div key={idx} className="group relative rounded-2xl overflow-hidden shadow-xl h-[400px]">
              ...
              <div className="absolute inset-0 z-0">
                ...
                <div className="absolute top-4 left-4 bg-accent text-primary px-3 py-1 rounded text-sm font-semibold shadow-lg">After</div>
              </div>
