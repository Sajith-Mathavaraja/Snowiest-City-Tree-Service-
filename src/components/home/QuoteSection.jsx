    ...
    <section className="py-24 relative overflow-hidden" id="contact">
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="bg-white/10 backdrop-blur-md rounded-3xl shadow-2xl overflow-hidden flex flex-col lg:flex-row border border-white/15">
          {/* Left Side - Benefits */}
          <div className="bg-primary/80 backdrop-blur-md text-white p-12 lg:w-2/5 flex flex-col justify-center relative overflow-hidden">
            ...
            <div className="relative z-10">
              <h3 className="text-3xl font-heading font-bold mb-6">Ready for a <span className="text-[#00d2ff]">healthier landscape?</span></h3>
              <p className="text-gray-200 mb-10 text-lg">Get a free, transparent estimate from our certified arborists today.</p>
              
              <ul className="space-y-6">
                <li className="flex items-start gap-4">
                  <div className="w-8 h-8 rounded-full bg-[#00d2ff]/20 flex items-center justify-center shrink-0 text-[#00d2ff] font-bold mt-1">1</div>
                  <div>
                ...
                <li className="flex items-start gap-4">
                  <div className="w-8 h-8 rounded-full bg-[#00d2ff]/20 flex items-center justify-center shrink-0 text-[#00d2ff] font-bold mt-1">2</div>
                  <div>
                ...
                <li className="flex items-start gap-4">
                  <div className="w-8 h-8 rounded-full bg-[#00d2ff]/20 flex items-center justify-center shrink-0 text-[#00d2ff] font-bold mt-1">3</div>
                  <div>
          ...
          <div className="p-8 lg:p-12 lg:w-3/5 w-full flex flex-col justify-center min-h-[600px] lg:min-h-[881px]">
            ...
            <div 
              className="w-full rounded-xl overflow-hidden bg-white/5 border border-white/10 shadow-inner"
              style={{ height: '881px' }}
            >
